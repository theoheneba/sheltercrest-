/*
  ...
  1. Changes
    - Drop existing RLS policies for security_settings table
    - Create new policies that properly allow admins to insert, update, and select records
    - Ensure only one row exists in the security_settings table
